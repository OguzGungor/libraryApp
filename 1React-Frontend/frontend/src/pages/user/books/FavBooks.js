...
import { getFavBooks, removeFavBook } from "../../../util/user/Books";
...
class FavBooks extends React.Component {
  ...
  columns = [
    ...
    },
    {
      ...
      render: (id) => (
        <div>
          <Button id={id} onClick={this.removeFavHandler.bind(this, id)}>
...
export default withRouter(FavBooks);