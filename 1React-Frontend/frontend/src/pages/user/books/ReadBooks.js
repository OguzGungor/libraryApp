...
import {  getReadBooks, removeReadBook } from "../../../util/user/Books";
...
class ReadBooks extends React.Component {
  ...
  removeReadHandler = (id) => {
    
    const { history ,match} = this.props;  
    removeReadBook(id).then((result)=>{
      alert(result);
  ...
  columns = [
    ...
    },
    {
      ...
      render: (id) => (
        <div>
          <Button id={id} onClick={this.removeReadHandler.bind(this, id)}>
